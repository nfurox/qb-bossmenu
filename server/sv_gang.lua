...
-- Grade Change
RegisterNetEvent('qb-gangmenu:server:updateGrade', function(data)
	local src = source
...
-- Fire Employee
RegisterNetEvent('qb-gangmenu:server:firedPlayer', function(target)
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	...
	if Employee then
		if Employee.Functions.SetGang("none", '0') then
			...
			TriggerClientEvent('QBCore:Notify', src, "Affiliate expelled!", "success")
			TriggerClientEvent('QBCore:Notify', Employee.PlayerData.source , "You have been expelled from the faction", "error")
		else
...
-- Recruit Player
RegisterNetEvent('qb-gangmenu:server:recruitPlayer', function(recruit)
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	...
	if Player.PlayerData.gang.isboss == true then
		if Target and Target.Functions.SetGang(Player.PlayerData.gang.name, 0) then
			...
			TriggerClientEvent('QBCore:Notify', Target.PlayerData.source , "You were hired as " .. Player.PlayerData.gang.label .. "", "success")			
